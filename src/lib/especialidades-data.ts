...
export const ESPECIALIDADES: Especialidade[] = [
  ...
  },
  {
    ...
    categoria: "sites",
    heroText: "Clientes pesquisam imóveis online muito antes de contatar qualquer corretor de imóveis profissional. Ter seu próprio SITE PARA CORRETOR profissional diferencia você no mercado saturado de portais imobiliários e coloca você no controle total da experiência do cliente desde o primeiro clique inicial. Quanto vale um lead qualificado que é só seu, sem compartilhar com dezenas de concorrentes? A resposta justifica o investimento.",
    sections: [
      {
  ...
  },
  {
    ...
    categoria: "sites",
    heroText: "Comida também se come com os olhos, e a decisão de onde jantar começa no Google muito antes de sair de casa. Seu SITE PARA RESTAURANTE precisa despertar o desejo irresistível antes mesmo do cliente provar seu prato. Quanto vale aparecer no topo quando alguém busca 'onde comer bem' na sua região? Cada clique pode se transformar em uma mesa ocupada e uma conta paga.",
    sections: [
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        conteudo: "Um SITE PARA IGREJA bem otimizado funciona como ferramenta evangelística poderosa 24 horas por dia. Pessoas em momentos de crise buscam no Google por 'igreja perto de mim', 'ajuda espiritual', 'horário de culto', 'igreja evangélica [bairro]'. Otimizamos seu site para aparecer nessas buscas, alcançando pessoas que nunca conheceriam sua comunidade de outra forma. O Google Meu Negócio configurado corretamente mostra sua igreja no Maps com horários, fotos e avaliações. Conteúdo devocional bem escrito atrai tráfego de pessoas buscando respostas espirituais para questões da vida. Cada visitante do site é potencial membro da comunidade. Métricas de acesso mostram de onde vêm os visitantes, quais conteúdos mais engajam e quantos pedidos de oração são recebidos. Esses dados informam a estratégia de comunicação e evangelismo da liderança, permitindo crescimento intencional e sustentável da comunidade de fé. Quanto custa um site para igreja? O investimento varia de R$5.000 a R$18.000 dependendo das funcionalidades incluídas. Oferecemos condições especiais para comunidades religiosas, entendendo que recursos são frequentemente limitados e precisam ser aplicados com sabedoria na obra do Senhor.",
      },
    ],
    beneficios: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        conteudo: "Entendemos que organizações do terceiro setor frequentemente operam com orçamentos restritos, e cada real precisa gerar máximo impacto social. Por isso, oferecemos condições especiais para ONGs e projetos sociais, com investimentos que partem de R$6.000 para sites institucionais até R$20.000 para plataformas completas com sistema de doações, gestão de voluntários e campanhas de arrecadação. Quanto vale um site que capta doações 24 horas? Nossos clientes do terceiro setor reportam que o investimento inicial se paga em 3-6 meses através de doações online que antes simplesmente não aconteciam. Um site profissional também abre portas para editais de financiamento e parcerias corporativas que exigem presença digital estruturada como critério de seleção. Oferecemos planos de pagamento facilitados, entendendo a realidade de fluxo de caixa de organizações sociais. Nosso compromisso vai além do técnico: acreditamos no poder transformador do terceiro setor e queremos ver sua organização crescer, impactar mais vidas e construir o mundo melhor que todos merecemos. Cada site que desenvolvemos para ONGs é uma contribuição nossa para causas que importam.",
      },
    ],
    beneficios: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        conteudo: "O investimento em um Micro-SaaS varia conforme a complexidade, mas nossa filosofia é começar enxuto e validar antes de investir pesado. Um MVP funcional tipicamente custa entre R$25-60 mil e fica pronto em 4-8 semanas. Esse valor inclui design, desenvolvimento, infraestrutura inicial, integração de pagamentos com Stripe, e publicação. Comparado ao custo de contratar uma equipe interna (salários, encargos, gestão, infraestrutura), terceirizar o desenvolvimento do MVP faz sentido financeiro para a maioria dos founders. Após validação do mercado, oferecemos pacotes mensais de evolução contínua que permitem adicionar funcionalidades, corrigir bugs e escalar infraestrutura conforme sua base de usuários cresce. O modelo de pagamento é transparente: você sabe exatamente o que está pagando a cada fase, sem surpresas ou custos ocultos. Muitos de nossos Micro-SaaS clientes atingem break-even em 6-12 meses e se tornam negócios lucrativos que geram renda passiva ou mesmo substitui a renda principal do founder. Já desenvolvemos mais de 15 Micro-SaaS para founders brasileiros e internacionais, acumulando experiência prática que acelera seu projeto e evita erros comuns de primeira viagem. Nosso diferencial está na combinação de expertise técnica com visão de negócio: não apenas desenvolvemos software, mas ajudamos a construir empresas digitais sustentáveis e escaláveis.",
      },
    ],
    beneficios: [
      "MVP em 4-8 semanas",
