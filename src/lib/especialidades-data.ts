...
export const ESPECIALIDADES: Especialidade[] = [
  ...
  },
  {
    ...
    categoria: "sites",
    heroText: "Clientes pesquisam imóveis online muito antes de contatar qualquer corretor de imóveis. Ter seu próprio SITE PARA CORRETOR profissional diferencia você no mercado saturado de portais imobiliários e coloca você no controle total da experiência do cliente desde o primeiro clique. Quanto vale um lead que é só seu, sem compartilhar com dezenas de concorrentes? A resposta justifica o investimento.",
    sections: [
      {
