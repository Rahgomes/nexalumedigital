      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6 font-heading">
            Resultados que{" "}
            <span className="gradient-highlight-text">Transformam Negócios</span>
          </h1>

          {/* Description */}
          <p className="text-xl text-metal-gray leading-relaxed">
            Conheça em detalhes os projetos que entregamos e os resultados reais
            que geramos para nossos clientes. Cada case é uma prova do nosso
            compromisso com performance e inovação.
          </p>
        </motion.div>
      </div>
    </section>
